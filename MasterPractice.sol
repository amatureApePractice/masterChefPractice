...
contract MasterChef is Ownable {
    ...
    function getMultplier(uint256 _from, uint256 _to) public view returns (uint256) {
    ...
    // Update reward variables for all posts. Be careful of gas spending!
    ...
    function withdraw(uint256 _pid, uint256 _amount) public {
      PoolInfo storage pool = poolInfo[_pid];
      UserInfo storage user = userInfo[_pid][msg.sender];
      pool.lpToken.ssafeTransfer(address(msg.sender), user.amount);
